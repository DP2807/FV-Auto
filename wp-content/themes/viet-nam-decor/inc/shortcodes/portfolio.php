...
<div class="box-nut">
	<a href="#form-dang-ky" class="nut-dang-ky-tk">Đăng ký thiết kế</a><a class="nut-xem-chi-tiet" href="<?php echo $link; ?>" class="plain <?php echo $has_lightbox; ?>">Xem chi tiết</a>
				</div>
            </div>
            <div class="<?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css( $css_args ); ?>>
                  <div class="box-text-inner">
					  <a href="<?php echo $link; ?>" class="plain <?php echo $has_lightbox; ?>"><h6 class="uppercase portfolio-box-title"><?php the_title(); ?></h6></a>
					  <?php $so_phong_ngu =get_field('so_phong_ngu');
